...
@Mod(
    modid = GrassMod.MODID,
    version = Tags.VERSION,
    name = "Grass! Let It Grow!",
...
public class GrassMod {
    ...
    @SidedProxy(
        serverSide = "com.gamingb3ast.GrassLiG.common.CommonProxy",
        clientSide = "com.gamingb3ast.GrassLiG.common.ClientProxy")
